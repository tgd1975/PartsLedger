...
**Epics:** [integration-followups](#integration-followups) · [markdown-inventory-schema](#markdown-inventory-schema) · [resistor-reader](#resistor-reader) · [skill-path-today](#skill-path-today) · [usb-camera-capture](#usb-camera-capture) · [visual-recognition](#visual-recognition)
