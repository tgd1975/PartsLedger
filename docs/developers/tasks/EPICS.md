...
**Overall:** 🔵 **active** — ██████░░░░ 8/13 (62%) across 1 group — 5 open · 0 active · 0 paused · 8 closed

## Index

| Epic | Title | Status | Open | Active | Paused | Closed | Done |
|------|-------|--------|-----:|-------:|-------:|-------:|------|
| [EPIC-001](#epic-001-align-with-circuitsmith-framework) | Align with CircuitSmith framework | 🔵 **active** | 5 | 0 | 0 | 8 | ██████░░░░ 62% |
