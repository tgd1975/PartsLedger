...
**Overall:** 🔵 **active** — ███████░░░ 9/13 (69%) across 1 group — 4 open · 0 active · 0 paused · 9 closed

## Index

| Epic | Title | Status | Open | Active | Paused | Closed | Done |
|------|-------|--------|-----:|-------:|-------:|-------:|------|
| [EPIC-001](#epic-001-align-with-circuitsmith-framework) | Align with CircuitSmith framework | 🔵 **active** | 4 | 0 | 0 | 9 | ███████░░░ 69% |
